            ...
            <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '2rem' }}>
                    ...
                    <div className="items-container">
                        {items.map((item, index) => (
                            <div key={item.id} className="glass-panel order-item-row">
                                <div className="filter-group">
                                    <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Cant.</label>
                                    <input
                                        type="number"
                                        min="1"
                                        className="input-field"
                                ...
                                <div className="filter-group">
                                    <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Descripción</label>
                                    <input
                                        type="text"
                                        className="input-field"
                                ...
                                <div className="filter-group">
                                    <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Precio Unit. (S/)</label>
                                    <input
                                        type="number"
                                        min="0"
                                        step="0.01"
                                ...
                                <div className="filter-group">
                                    <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Subtotal (S/)</label>
                                    <input
                                        type="number"
                                        className="input-field"
                                        value={item.amount}
                                        readOnly
                                        style={{ backgroundColor: 'rgba(255,255,255,0.05)', cursor: 'not-allowed', color: 'var(--primary-color)', fontWeight: 'bold' }}
                                    />
                                </div>
                                <div className="filter-group">
                                    <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Adelanto (S/)</label>
                                    <input
                                        type="number"
                                        min="0"
                                        step="0.01"
                ...
                <div className="glass-panel" style={{
                    ...
                    <div style={{ textAlign: 'right' }}>
                        <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px' }}>Monto Total</span>
                        <span style={{ fontSize: '1.8rem', fontWeight: '900' }}>S/ {totals.amount.toFixed(2)}</span>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                        <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px' }}>Adelantado</span>
                    ...
                    <div style={{ textAlign: 'right', borderLeft: '2px solid var(--glass-border)', paddingLeft: '3rem' }}>
                        <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: '600', letterSpacing: '0.5px' }}>Saldo Restante</span>
